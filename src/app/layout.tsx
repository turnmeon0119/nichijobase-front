    ...
    <html lang="ja">
      ...
      >
        <header className="sticky top-0 z-20 border-b border-[var(--line)] bg-[rgba(246,243,237,0.92)] backdrop-blur-xl">
          <nav className="mx-auto flex max-w-6xl flex-wrap items-center gap-x-7 gap-y-3 px-5 py-4 sm:px-8">
            ...
            <Link href="/" className="text-sm font-medium hover:text-[var(--accent)]">
              ホーム
            </Link>
